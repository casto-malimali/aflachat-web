...
export default function Terms() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 animate-fade-up">
      ...
      <div className="prose prose-zinc -invert max-w-none space-y-10">
        <section>
        ...
        <section className="p-8 bg-zinc-50 -zinc-900 rounded-3xl border border-zinc-100 -zinc-800">
          <h2 className="text-2xl font-bold mb-4">7. Contact Information</h2>
          <p className="text-zinc-600 -zinc-400 mb-4">
