...
export default function Privacy() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 animate-fade-up">
      ...
      <h1 className="text-4xl md:text-5xl font-bold mb-3" style={{ fontFamily: "var(--font-playfair,'Playfair Display',Georgia,serif)" }}>{t.privacy.title}</h1>
      <p className="text-zinc-500 mb-12 text-sm">{t.privacy.lastUpdated}</p>
      
      <div className="prose prose-zinc -invert max-w-none space-y-12">
        <section>
          <p className="text-zinc-600 -zinc-400 leading-relaxed text-lg">
        ...
        <section>
          ...
          <p className="text-zinc-600 -zinc-400 leading-relaxed">
          ...
          <p className="text-zinc-600 -zinc-400 mt-4">
        ...
        <section>
          ...
          <p className="text-zinc-600 -zinc-400 leading-relaxed mb-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-zinc-600 -zinc-400">Users may voluntarily provide information when interacting with the application, including:</p>
            <ul className="list-disc pl-6 text-zinc-600 -zinc-400 space-y-2">
          ...
          <div className="space-y-4 mt-6">
            ...
            <p className="text-zinc-600 -zinc-400">The application may automatically collect certain technical information, such as:</p>
            <ul className="list-disc pl-6 text-zinc-600 -zinc-400 space-y-2">
              <li>Device type</li>
            ...
            <p className="text-zinc-600 -zinc-400 italic">This information helps improve the reliability and performance of the application.</p>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-zinc-600 -zinc-400 mt-6 font-medium">
        ...
        <section>
          ...
          <p className="text-zinc-600 -zinc-400 mt-4 italic">
        ...
        <section>
          ...
          <p className="text-zinc-600 -zinc-400 mt-4 font-medium text-secondary">
        ...
        <section className="bg-zinc-50 -zinc-900/50 p-8 rounded-3xl border border-zinc-100 -zinc-800">
