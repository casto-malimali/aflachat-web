      ...
      <div className="prose prose-zinc max-w-none space-y-12">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <p className="text-zinc-600">Users may voluntarily provide information when interacting with the application, including:</p>
          ...
          <div className="space-y-4 mt-6">
            ...
            <p className="text-zinc-600">The application may automatically collect certain technical information, such as:</p>
            <ul className="list-disc pl-6 text-zinc-600 space-y-2">
              <li>Device type</li>
            ...
            <p className="text-zinc-600 italic">This information helps improve the reliability and performance of the application.</p>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-zinc-600 mt-6 font-medium">
        ...
        <section>
          ...
          <p className="text-zinc-600 mt-4 font-medium text-secondary">
